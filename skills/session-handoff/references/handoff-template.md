...
- [TODO: If the handoff references artifacts that live outside the repo (chat messages, sketches, drafts), save copies under `.claude/handoffs/artifacts/` and link them here]
