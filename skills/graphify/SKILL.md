---
name: graphify
description: "Build a navigable knowledge graph from a folder of files (code, docs, papers, images) with community detection and three outputs: interactive HTML, GraphRAG-ready JSON, and a plain-language audit report. Use when asked to graph a codebase, visualize a project's structure, build a knowledge graph, or run /graphify."
---
